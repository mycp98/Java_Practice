...
public class LoopPractice {
    public static void main(String[] args) {
        ...
        //Using nested while loops, iterate through all the elements in the 2D array and print them to the console using the format: word [row][column]. The formatted print statement has been provided.
